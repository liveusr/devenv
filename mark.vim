...
" if &t_Co < 256
" 	hi MarkWord1 guifg=Black ctermfg=Black guibg=#5FD700 ctermbg=Green
" 	hi MarkWord2 guifg=Black ctermfg=Black guibg=#00D7FF ctermbg=Cyan
" 	hi MarkWord3 guifg=White ctermfg=White guibg=#0087FF ctermbg=Blue
" 	hi MarkWord4 guifg=White ctermfg=White guibg=#AF00FF ctermbg=Magenta
" 	hi MarkWord5 guifg=White ctermfg=White guibg=#FF0000 ctermbg=Red
" 	hi MarkWord6 guifg=White ctermfg=White guibg=#FF0000 ctermbg=Brown
" 	hi MarkWord7 guifg=Black ctermfg=Black guibg=#FFD700 ctermbg=Gray
" 	hi MarkWord8 guifg=Black ctermfg=Black guibg=#FFD700 ctermbg=White
" 	hi MarkWord9 guifg=Black ctermfg=Black guibg=#FFD700 ctermbg=Yellow
" else
...
if &t_Co < 256
	...
	hi MarkWord1 guifg=Black ctermfg=Black guibg=#5FD700 ctermbg=Green
	hi MarkWord2 guifg=Black ctermfg=Black guibg=#00D7FF ctermbg=Cyan
	hi MarkWord3 guifg=Black ctermfg=Black guibg=#0087FF ctermbg=Blue
	hi MarkWord4 guifg=Black ctermfg=Black guibg=#AF00FF ctermbg=Magenta
	hi MarkWord5 guifg=Black ctermfg=Black guibg=#FF0000 ctermbg=Red
	hi MarkWord6 guifg=White ctermfg=White guibg=#FF0000 ctermbg=Brown
	hi MarkWord7 guifg=Black ctermfg=Black guibg=#FFD700 ctermbg=Gray
	hi MarkWord8 guifg=Black ctermfg=Black guibg=#FFD700 ctermbg=White
	hi MarkWord9 guifg=Black ctermfg=Black guibg=#FFD700 ctermbg=Yellow
